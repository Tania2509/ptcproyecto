...
namespace Vistas.Formularios
{
    public partial class frmGestionTrabajadores : Form
    {
        ...
        private void btnAgregarTrabajadorJSMN_Click(object sender, EventArgs e)
        {
        ...
        private void btnActualizarTJSMN_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txtNombre.Text) ||
               string.IsNullOrWhiteSpace(txtApellido.Text) ||
               string.IsNullOrWhiteSpace(txtTelefono.Text) ||
        ...
        private void btnEliminarTrabajadorJSMN_Click(object sender, EventArgs e)
        {
